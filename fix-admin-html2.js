...
const searchH3 = '<h3 style="margin:0">📊 Estadísticas de Ventas</h3>';
const replaceFilters = '<div style="display:flex; gap: 1rem; align-items:center">\n' +
...
html = html.replace(searchH3, replaceFilters);
